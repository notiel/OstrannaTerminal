...
class Settings(QtWidgets.QWidget, settings_design.Ui_Form):
    ...
    def save_settings(self):
        ...
        settings_save = {'COM settings': {'baudrate': self.settings.baudrate, 'databits': self.settings.databits,
                         ...
                         'Text settings': {'CRLF': self.text_settings.CRLF,
                                           'SlashR': self.text_settings.slashr,
                                           'SlashN': self.text_settings.slashn,
                                           'bytecodes': self.text_settings.bytecodes,
                                           ...
                                           'first_period': self.text_settings.first_period,
                                           'second_period': self.text_settings.second_period,
                                           'first_transmit': self.text_settings.first_transmit,
                                           'second_transmit': self.text_settings.second_transmit,
                                           'first_repeat': self.text_settings.first_repeat,
                                           'second_repeat': self.text_settings.second_repeat},
                         'Colors': self.colors,
