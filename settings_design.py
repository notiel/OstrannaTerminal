...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.BtnBackgroundColor = QtWidgets.QPushButton(self.GBColor)
        self.BtnBackgroundColor.setObjectName("BtnBackgroundColor")
        self.gridLayout_6.addWidget(self.BtnBackgroundColor, 3, 0, 1, 1)
        self.BtnReceivedColor = QtWidgets.QPushButton(self.GBColor)
        self.BtnReceivedColor.setObjectName("BtnReceivedColor")
        self.gridLayout_6.addWidget(self.BtnReceivedColor, 3, 3, 1, 1)
        ...
        self.LblBackground = QtWidgets.QLabel(self.GBColor)
        self.LblBackground.setObjectName("LblBackground")
        self.gridLayout_6.addWidget(self.LblBackground, 1, 0, 1, 1)
        self.LblReceivedFont = QtWidgets.QLabel(self.GBColor)
        self.LblReceivedFont.setObjectName("LblReceivedFont")
        self.gridLayout_6.addWidget(self.LblReceivedFont, 1, 3, 1, 1)
        self.LblBackgroundColor = QtWidgets.QLabel(self.GBColor)
        ...
        self.gridLayout_6.addWidget(self.LblBackgroundColor, 2, 0, 1, 1)
        self.LblReceivedColor = QtWidgets.QLabel(self.GBColor)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(10)
        ...
        self.gridLayout_6.addWidget(self.LblReceivedColor, 2, 3, 1, 1)
        self.LblFontSent = QtWidgets.QLabel(self.GBColor)
        self.LblFontSent.setObjectName("LblFontSent")
        self.gridLayout_6.addWidget(self.LblFontSent, 1, 1, 1, 2)
        self.BtnSentColor = QtWidgets.QPushButton(self.GBColor)
        self.BtnSentColor.setObjectName("BtnSentColor")
        self.gridLayout_6.addWidget(self.BtnSentColor, 3, 1, 1, 2)
        self.LblSentColor = QtWidgets.QLabel(self.GBColor)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(10)
        ...
        self.gridLayout_6.addWidget(self.LblSentColor, 2, 1, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.LblBackground.setText(_translate("Form", "Backround Color"))
        self.LblReceivedFont.setText(_translate("Form", "Font Received Color"))
        self.LblReceivedColor.setText(_translate("Form", "Received"))
        self.LblFontSent.setText(_translate("Form", "Font Sent Color"))
